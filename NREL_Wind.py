...
nm.mainRandEx_old( mesh, R_L, dR_L, 0.1, 400, nm.get_random_init_pt(8, 46))
nm.subspEx(mesh, R_L, dR_L, 1, 0, .2)

#Build the AM for visualization
am, fvals = nm.build_AM_from_data( nm.get_random_init_pt(8, 46), mesh, R_L, dR_L_path, dR_L, 0.01)
...
nm.mainRandEx_old( mesh, R_S, dR_S, 0.1, 400, nm.get_random_init_pt(8, 46))
nm.subspEx(mesh, R_S, dR_S, 2, 0, .2)

#Build the AM for visualization
am, fvals = nm.build_AM_from_data( nm.get_random_init_pt(8, 46), mesh, R_S, dR_S_path, dR_S, 0.01)
